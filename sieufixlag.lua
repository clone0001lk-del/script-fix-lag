--[[
    Blox Fruits OPTIMIZER GODLIKE (Gom Gọn 6 Nhóm Tối Ưu)
...
-- Khung chính của Menu (Thu gọn lại vừa vặn cho 6 nút)
...
NameTagText.Text = "⚡ DƯƠNG HƯNG ĐẸP TRAI - GOM GỌN 6 NHÓM ⚡"
...
-- ==================== 6 NHÓM TỐI ƯU TOÀN DIỆN (Gom từ 40 tính năng) ====================

createGroupButton("GroupGraphics", "🚀 ĐỒ HỌA & MAP", "Tối ưu RAM/GPU, Map xám, Tắt hiệu ứng sáng, Xóa Texture & Nước.", 1, function(state)
    -- Gom nhóm 1: Đồ họa & Môi trường
...
createGroupButton("GroupCombat", "⚔️ CHIẾN ĐẤU & FPS", "Khóa 60 FPS, Xóa skill rác, Chống rung camera & Đóng băng đạn.", 2, function(state)
    -- Gom nhóm 2: Hiệu năng chiến đấu & FPS
...
createGroupButton("GroupRAM", "🧹 DỌN RÁC & CPU", "Siêu dọn RAM tự động, Xóa sound thừa & Cân bằng luồng xử lý CPU.", 3, function(state)
    -- Gom nhóm 3: Quản lý RAM & Luồng CPU
...
createGroupButton("GroupAudioUI", "🔇 ÂM THANH & KHÁC", "Tắt toàn bộ âm thanh, Chống mờ màn hình & Xóa bảng sát thương.", 6, function(state)
    -- Gom nhóm 6: Âm thanh, UI phụ & Hiệu ứng sáng
...
print("🔥 Đã gom gọn thành 6 nhóm tối thượng - Giao diện cực sạch cho Dương Hưng Đẹp Trai!")
